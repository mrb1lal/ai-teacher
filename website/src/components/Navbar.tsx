...
import { Menu, X as CloseIcon, Bot, Link, X as TwitterIcon, Code, Github, ChevronDown } from 'lucide-react';

const socialLinks = [
  { href: 'https://t.me/myaitecherbot', icon: Bot, label: 'Bot', ariaLabel: 'Telegram Bot' },
  { href: 'https://www.linkedin.com/in/bilal-ahmadjanov-391784414', icon: Link, label: 'LinkedIn', ariaLabel: 'LinkedIn' },
  { href: 'https://x.com/Feluvan1', icon: TwitterIcon, label: 'X', ariaLabel: 'X (Twitter)' },
